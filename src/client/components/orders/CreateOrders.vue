...
<template>
    <el-card>
        <el-form v-if="isLogin" ref="elFormRef" :model="formOrders" label-width="auto" label-position="top">
            <el-form-item label="单据编号" prop="gjpId" required>
                <el-input name="gjpId" v-model="formOrders.gjpId" placeholder="SD-YYYY-MM-DD-NNNNN"></el-input>
            </el-form-item>
            <el-form-item label="客户名称" prop="client">
                <el-input name="client" v-model="formOrders.client" placeholder="选填"></el-input>
            </el-form-item>
            <el-form-item label="切纸单" prop="image" required>
            ...
            <el-form-item label="留言">
                <el-input type="textarea" name="note" v-model="formOrders.note" resize="none" placeholder="选填"
                    :rows="3" />
            </el-form-item>
            <el-form-item>
